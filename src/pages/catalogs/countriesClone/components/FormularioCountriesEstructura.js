...
import useModalAreaEstructura from '../hooks/useModalCountriesEstructura';
...
const FormularioCountriesEstructura = ({
  ...
  const { handleSubmit, onSubmit, control, isLoadingButton } =
    useModalAreaEstructura({ onClose, row, onComplete });
