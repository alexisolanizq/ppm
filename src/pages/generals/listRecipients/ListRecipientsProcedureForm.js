...
import {
  TYPE_LIST_RECIPIENT,
  TYPE_RECIPIENT_LIST_PROCEDURE
} from '@Const/lists';

import useListRecipientsProcedureForm from '@Hooks/generals/useListRecipientsProcedureForm';

import TreeViewComponent from '../../../component/common/treeView/TreeViewComponent';

const ListRecipientsProcedureForm = ({
  isUpdate = false,
  onCancel = () => {},
  onEnd = () => {},
  row = null
  ...
  } = useListRecipientsProcedureForm({ row, isUpdate, onEnd });
  ...
  return (
    <>
      ...
      >
        <Text>Tipo de lista de destinatario</Text>
        ...
        <RadioGroupController
          ...
          options={TYPE_RECIPIENT_LIST_PROCEDURE}
          rules={fieldRequired}
          optionValue="value"
          isHorizontal
        />
...
export default ListRecipientsProcedureForm;
