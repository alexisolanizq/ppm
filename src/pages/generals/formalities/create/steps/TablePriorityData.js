                  ...
                  <DesktopDatePicker
                    ...
                    renderInput={(params) => (
                      <TextField
                        {...params}
                        helperText={
                          errors && row.date === null
                            ? 'lklk'
                            : ''
                        }
                        color="success"
                        error={getErrorValueNull(row.date)}
                      />
                    )}
                  />
                </Stack>
                ...
                <>
                  ...
                  <TableCell>
                    <TextField
                      ...
                      variant="outlined"
                      helperText={
                        errors && row.codeDas === '' ? 'lklk' : ''
                      }
                      sx={{
                        display: 'flex',
                        flexWrap: 'nowrap'
                      }}
                      error={getErrorValue(row.codeDas)}
                      value={row.codeDas}
                      onChange={(e) =>
...
export default TablePriorityData;
