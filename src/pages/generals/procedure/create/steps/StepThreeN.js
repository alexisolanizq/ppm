  ...
  <LocalizationProvider dateAdapter={AdapterDateFns}>
    ...
    >
      <TextField
        ...
        color="success"
        variant="outlined"
        helperText={error && registrationData.numberPCT === '' ? 'lklk' : ''}
        className="mb-3"
      ...
      <TextField
        ...
        variant="outlined"
        helperText={
          error && registrationData.titleProcedurePantentEn === '' ? 'lklk' : ''
        }
        className="mb-3"
      ...
      <TextField
        ...
        variant="outlined"
        helperText={
          error && registrationData.titleProcedurePantentEs === '' ? 'lklk' : ''
        }
        className="mb-3"
    ...
    >
      <TextField
        ...
        multiline
        color="success"
        helperText={error && registrationData.case === '' ? 'lklk' : ''}
          ...
          <DesktopDatePicker
            ...
            renderInput={(params) => (
              <TextField
                {...params}
                helperText={
                  error && registrationData.filingDate === null ? 'lklk' : ''
                }
                color="success"
          ...
          <DesktopDatePicker
            ...
            renderInput={(params) => (
              <TextField
                {...params}
                helperText={
                  error && registrationData.expirationDate === null
                    ? 'lklk'
                    : ''
                }
                color="success"
