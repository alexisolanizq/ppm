...
const StepTwoP = ({
  ...
  <>
    ...
    <FormGroup className="mb-3 ml-05 w-100 d-flex flex-row align-items-center lh-1 h-fit">
      <Typography className="form-label mr-3">¿Es divisional?</Typography>
    ...
    {registrationData.isDivisional ? (
      <>
        <TextField
          ...
          variant="outlined"
          helperText={
            errors && registrationData.motherReference === '' ? 'lklk' : ''
          }
          className="mb-3"
        ...
        />
        <Button variant="text" className="text-right w-fit ml-auto">
          Validar referencia madre
        </Button>
        <FormControl
          fullWidth
          className="mb-3"
        ...
        >
          ...
          {errors && registrationData.divisional === '' ? (
            <FormHelperText>lklk</FormHelperText>
          ) : (
            ''
          )}
